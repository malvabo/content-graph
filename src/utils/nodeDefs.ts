...
export const NODE_DEFS: NodeDef[] = [
  ...
  { subtype: 'voice-source', label: 'Voice Note', badge: 'Vc', category: 'source', description: 'Record a voice note', hasInput: false, hasOutput: true },
  { subtype: 'link-source', label: 'Link', badge: 'Lk', category: 'source', description: 'Paste a URL to use as source', hasInput: false, hasOutput: true },
  // Generate
