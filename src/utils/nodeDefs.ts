...
export const DEFAULT_MODELS: Record<string, string> = {
  'refine': 'llama-3.3-70b',
  'linkedin-post': 'llama-3.3-70b',
  'twitter-thread': 'llama-3.3-70b',
  'twitter-single': 'llama-3.3-70b',
  'newsletter': 'llama-3.3-70b',
  'infographic': 'llama-3.3-70b',
  'quote-card': 'llama-3.3-70b',
  'image-prompt': 'llama-3.3-70b',
  'text-source': 'llama-3.3-70b',
  'file-source': 'llama-3.3-70b',
  'brand-voice': 'llama-3.3-70b',
};
