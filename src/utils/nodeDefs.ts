...
export const NODE_DEFS: NodeDef[] = [
  ...
  { subtype: 'prompt', label: 'Prompt', badge: 'Pm', category: 'transform', description: 'Topic or focus filter injected into downstream nodes', hasInput: false, hasOutput: true },
