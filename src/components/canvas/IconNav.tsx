...
const CreateIcon = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v3M12 18v3M3 12h3M18 12h3M5.6 5.6l2.1 2.1M16.3 16.3l2.1 2.1M5.6 18.4l2.1-2.1M16.3 7.7l2.1-2.1"/></svg>;
const CaptureIcon = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="8" y1="22" x2="16" y2="22"/></svg>;
  ...
  return (
    <>
      ...
      >
        ...
        <NavItem icon={<CreateIcon />} label="Create" expanded={true} active={activeView === 'create'} onClick={() => onViewChange('create')} />
        <NavItem icon={<CaptureIcon />} label="Capture" expanded={true} active={activeView === 'capture'} onClick={() => onViewChange('capture')} />
