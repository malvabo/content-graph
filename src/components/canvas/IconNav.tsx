  ...
  return (
    <>
      ...
      <nav aria-label="Main navigation" className="icon-nav"
        style={{ width: 200, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'stretch', padding: '12px 4px', gap: 2, flexShrink: 0, background: 'var(--color-nav-bg)', border: 'none', borderRadius: 0, boxShadow: 'none', position: 'relative', zIndex: 2 }}>
