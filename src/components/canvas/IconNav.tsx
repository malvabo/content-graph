  ...
  return (
    <>
      ...
      <nav aria-label="Main navigation" className="icon-nav"
        style={{ width: 200, height: 'calc(100% - 16px)', margin: '8px', display: 'flex', flexDirection: 'column', alignItems: 'stretch', padding: '12px 4px', gap: 2, flexShrink: 0, background: 'var(--color-nav-bg)', border: '1px solid var(--color-border-subtle)', borderRadius: 16, boxShadow: '0px 2px 10px 0px rgba(0, 0, 0, 0.1)', position: 'relative', zIndex: 2 }}>
