...
const ChatIcon = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>;
...
export default function IconNav({ activeView, onViewChange }: Props) {
  return (
    <nav className="w-[64px] shrink-0 flex flex-col items-center py-3 px-1 gap-1" style={{ background: 'var(--cg-card)', borderRight: '1px solid var(--cg-border)' }}>
      ...
      <NavItem icon={<ChatIcon />} label="Chat" active={activeView === 'chat'} onClick={() => onViewChange('chat')} />
