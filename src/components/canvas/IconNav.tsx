...
function DarkModeToggle() {
  ...
  return (
    <button onClick={() => setDark(!dark)} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}
      ...
      style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', width: 40, height: 40, padding: 0, borderRadius: 8, background: hover ? 'var(--color-bg-surface)' : 'transparent', color: 'var(--color-text-tertiary)', border: 'none', cursor: 'pointer', flexShrink: 0 }}>
