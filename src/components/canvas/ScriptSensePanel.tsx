...
export default function ScriptSensePanel({ scriptId, initialText, onBack, onOpenInCards, onSendToWorkflow, onDelete }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden" style={{ background: 'var(--color-bg-card)', position: 'relative', margin: 8, height: 'calc(100% - 16px)', borderRadius: 12, border: '1px solid var(--color-border-subtle)', boxShadow: '0px 2px 10px 0px rgba(0, 0, 0, 0.1)' }}>
