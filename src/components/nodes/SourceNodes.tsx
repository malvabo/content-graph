...
function AiEditPopover({ selectedText, position, onApply, onClose }: {
  ...
  return (
    <div ref={ref} className="absolute z-50" style={{ left: position.x, top: position.y }}>
      {!showPrompt ? (
        <div className="flex items-center gap-0.5 rounded-xl px-1 py-1" style={{ background: 'var(--cg-card)', boxShadow: '0 4px 20px rgba(0,0,0,0.12), 0 0 0 1px rgba(0,0,0,0.06)' }}>
        ...
        <div className="w-[240px] rounded-xl p-3 flex flex-col gap-2.5" style={{ background: 'var(--cg-card)', boxShadow: '0 8px 32px rgba(0,0,0,0.12), 0 0 0 1px rgba(0,0,0,0.06)' }}>
          <div style={{ font: '500 12px/1 var(--font-sans)', color: 'var(--cg-ink-3)' }}>Edit this text</div>
