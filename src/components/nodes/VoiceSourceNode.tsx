...
export function VoiceSourceInline({ id }: { id: string }) {
  ...
  const stopRecording = useCallback(async () => {
    ...
    // Generate AI title and update both the note and the node config
  ...
  return (
    ...
    >
      ...
      {noteTitle ? (
        /* Filled state: show title + duration + re-record */
        <div
          style={{
