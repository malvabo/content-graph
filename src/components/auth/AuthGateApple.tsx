...
// Separate login variant that adds a "Continue with Apple" button alongside
// the existing options. Rendered only when the `?auth=apple` URL flag is set,
// so the live login stays untouched until we flip it on. See App.tsx.
